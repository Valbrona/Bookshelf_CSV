...
"""
from utils import my_database_CSV
...
def menu():
    my_database_CSV.create_book_table()
...
def prompt_add_book():
    ...
    my_database_CSV.add_book(user_book, user_author)


# def list_books() ----> show all books in our list
def list_books():
    books = my_database_CSV.get_all_books()
    for book in books:
...
def prompt_read_books():
    ...
    my_database_CSV.mark_book_as_read(user_input)
...
def prompt_delete_book():
    ...
    my_database_CSV.delete_book(user_input)
